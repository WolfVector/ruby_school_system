class Maestro < ApplicationRecord
  ...
  has_many :clase, class_name: "Clase"
    ...
    def send_confirmation_email!(token_exp)
      #No se enviaría correo de confirmación, simplemente se enviría un mensaje para notificarle
      #que ha sido registrado en la plataforma
    end
